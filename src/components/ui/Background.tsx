...
export const Background: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[40vw] h-[40vw] bg-[#15c03f20] rounded-full blur-[100px] animate-pulse"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-[40vw] h-[40vw] bg-[#00ff4010] rounded-full blur-[100px] animate-pulse delay-10000"></div>
