...
export const Background: React.FC = () => {
  ...
  return (
    <>
      ...
      <div ref={cursorRef} className="hidden md:block fixed top-0 left-0 w-[400px] h-[400px] bg-white/5 rounded-full blur-[80px] -translate-x-1/2 -translate-y-1/2 pointer-events-none z-0 mix-blend-overlay"></div>
    </>
  );
};